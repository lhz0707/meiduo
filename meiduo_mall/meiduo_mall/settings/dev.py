...
SECRET_KEY = 'r3kdy_wyju$h!eg%2i(#ob6$y18x3s$god(z=elr%ffbg*3b52'
...
EMAIL_HOST_PASSWORD = 'lhz19980707' # 邮箱授权时获得的密码，非注册登录密码
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.0.104:9200/', # Elasticsearch服务器ip地址，端口号固定为9200
